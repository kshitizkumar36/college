...
<?php 
$query_edit="SELECT * FROM `posts` WHERE `id`='$id'";
$run_edit= mysqli_query($connect,$query_edit);
$data= mysqli_fetch_assoc($run_edit);
      ...
      <div class="card-body">
        ...
        <form id="formValidationExamples" class="row g-6" action="php_code/backend.php" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-4">
            <label class="form-label" for="formValidationName">Choose Blog Category</label>
           	<select class="form-control" name="blog_menu">
           		...
           		{
           			?>
           			<option <?php if($data['menu']==$data_menu['id']){echo"selected";} ?> value="<?php echo $data_menu['id']; ?>"><?php echo $data_menu['menu']; ?></option>
           			<?php
           		}
          ...
          <div class="col-md-4">
            ...
            <textarea class="form-control" name="subtitle"><?php echo $data['subtitle']; ?></textarea>
          </div>
          ...
          <div class="col-md-6">
            ...
            <img height="100" src="../<?php echo $data['main_img']; ?>">
          ...
          <div class="row gy-3 mt-0">
            	 ...
            	 <div class="col-md-12">
		            ...
		            <textarea class="form-control" name="blog_part_1" id="blog1"><?php echo $data['detail1']; ?></textarea>
		          </div>
          </div>
          ...
          <div class="row gy-3 mt-0">
            	 ...
            	 <div class="col-md-12">
		            ...
		            <textarea class="form-control" name="blog_part_2" id="blog2"><?php echo $data['detail2']; ?></textarea>
		          </div>
          </div>
   ...
   <div class="col-12">
          ...
          <div class="row gy-3 mt-0">
            	 ...
            	 <div class="col-md-12">
		            ...
		            <textarea class="form-control" name="blog_part_3" id="blog3"><?php echo $data['detail3']; ?></textarea>
		          </div>
          </div>
          ...
          <div class="col-md-6">
            ...
            <img height="100" src="../<?php echo $data['img1']; ?>">
           ...
           <div class="col-md-6">
            ...
            <img height="100" src="../<?php echo $data['img2']; ?>">
           ...
           <div class="col-md-6">
            ...
            <img height="100" src="../<?php echo $data['img3']; ?>">
          ...
          <div class="row gy-3 mt-0">
            	 ...
            	 <div class="col-md-12">
		            ...
		            <textarea class="form-control" name="blog4" id="blog4"><?php echo $data['detail4']; ?></textarea>
		          </div>
          </div>
            ...
            <div class="row gy-3 mt-0">
               ...
               <div class="col-md-12">
                ...
                <textarea class="form-control" name="youtube" id="youtube" placeholder="https://www.youtube.com/watch?--->(v=k7HfZf-OGuk)<---- &list=RDMMk7HfZf-OGuk&start_radio=1">k7HfZf-OGuk</textarea>
              </div>
          </div>
