                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                            $id = 1;
                                            $query1 = "SELECT * FROM `posts` WHERE `user_id`='$user_id' ORDER BY `id` DESC";
                                            ...
                                            ?>
                                                <tr>
                                                        ...
                                                        if ($status == 0) 
                                                        {
                                                            ?>
                                                                <form method="post" action="php_code/backend.php">
                                                                    ...
                                                                    <button type="submit" class="badge bg-warning" name="activate">De-Activated</button>
                                                                </form>
                                                        ...
                                                        } else
                                                         {
                                                            ?>
                                                             <form method="post" action="php_code/backend.php">
                                                                    <input type="hidden" value="<?php echo $data['id']; ?>" name="post_id">
                                                                    <button type="submit" class="badge bg-success" name="deactivate">Activated</button>
                                                                </form>
                                                    ...
                                                    <td>
                                                       ...
                                                       <form method="post" action="php_code/backend.php">
                                                            <input type="hidden" value="<?php  echo $data['id']; ?>" name="post_id">
                                                           <button type="submit" name="delete_post" class=" btn btn- danger"><i class="text-danger fa-solid fa-trash"></i></button>
                                                       </form>
                                                    </td>
                                                </tr>
                                            <?php
