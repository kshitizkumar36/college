    ...
    <div class="card mb-6">
      ...
      <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-8">
        ...
        <div class="flex-grow-1 mt-3 mt-lg-5">
          ...
          <button class="btn btn-primary" type="submit" name="update_photo">Update Photo</button>
      ...
      <div class="card-body">
        ...
        <ul class="list-unstyled my-3 py-1">
          <li class="d-flex align-items-center mb-4"><i class="bx bx-user"></i><span class="fw-medium mx-2">Full Name:</span> <span>
            <input type="text" class="form-control" value="<?php echo $profile_data['username']; ?>" name="username">
            ...
            <input  type="text" class="form-control" value="<?php echo $profile_data['password']; ?>" name="password">
          ...
          <li class="d-flex align-items-center mb-4"><i class="bx bx-flag"></i><span class="fw-medium mx-2">City:</span> <span>
            <input type="text" class="form-control" value="<?php echo $profile_data['city']; ?>" name="city">
          </span></li>

          <li class="d-flex align-items-center mb-4"><i class="bx bx-flag"></i><span class="fw-medium mx-2">State:</span> <span>
            <input type="text" class="form-control" value="<?php echo $profile_data['state']; ?>" name="state">
          </span></li>
          <li class="d-flex align-items-center mb-4"><i class="bx bx-flag"></i><span class="fw-medium mx-2">Country:</span> <span>
            <input type="text" class="form-control" value="<?php echo $profile_data['country']; ?>" name="country">
          </span></li>


          <li class="d-flex align-items-center mb-4"><i class="bx bx-flag"></i><span class="fw-medium mx-2">Facebook:</span> <span>
            <input type="text" class="form-control" value="<?php echo $profile_data['facebook']; ?>" name="facebook">
          </span></li>

          <li class="d-flex align-items-center mb-4"><i class="bx bx-flag"></i><span class="fw-medium mx-2">Instagram:</span> <span>
            <input type="text" class="form-control" value="<?php echo $profile_data['insta']; ?>" name="instagram">
          </span></li>

          <li class="d-flex align-items-center mb-4"><i class="bx bx-flag"></i><span class="fw-medium mx-2">Whatsapp :</span> <span>
            <input type="text" class="form-control" value="<?php echo $profile_data['whatsapp']; ?>" name="whatsapp">
          </span></li>

          <li class="d-flex align-items-center mb-4"><i class="bx bx-flag"></i><span class="fw-medium mx-2">About:</span> <span>
          </span>
          <textarea name="about" class="form-control"><?php echo $profile_data['about']; ?> </textarea>
        </li>

        <input type="hidden" value="<?php echo $user_id; ?>" name="user_id">

        <button type="submit" name="update_profile" class="btn btn-success">Update Now</button>
